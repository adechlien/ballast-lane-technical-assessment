## 1. Tools Used
### ChatGPT
As my only agent, I use it to generate structures and code I already understand, more focused in Frontend code or mockups to be changed later.
...
## 2. My Approach
### First Steps
As a starting plan, I knew I want to develop something related with my projects, so I thought of making a Reading/Writing Catalog (for my blog) or a Color Token Manager (for Adech themes), so I asked ChatGPT which idea sounds better for implementing a full-stack web application in no more than 3 days.
